...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Spoke to Customer</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Spoke to Customer' or . = 'Spoke to Customer')]</locator>
