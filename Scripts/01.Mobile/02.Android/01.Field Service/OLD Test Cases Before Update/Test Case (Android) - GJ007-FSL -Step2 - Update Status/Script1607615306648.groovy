...
Tap Action lightning button , change status

select radio button 
Tap Next button

validate finish msg isdisplay

*/
Mobile.startApplication(GlobalVariable.AndroidAppFile, false)

/////////////////////////////////// this part is STEP 1 only for debug using, will be delete after debug//////////////
Mobile.delay(5)
...
Mobile.comment('View service Appointment-Tap lightning button')

////////////////////////////////////////////////////
//Tap Action lightning button
Mobile.tap(findTestObject('04.Mobile/02.Android/01.FS.GJ-FieldServicesActions/Service Appointment Details Page/android.widget.TextView - Actions - Lightning Image Btn'), 
    10)
...
//Tap Actions
Mobile.tap(findTestObject('04.Mobile/02.Android/01.FS.GJ-FieldServicesActions/Service Appointment Work Order Page/android.view.Change Status - Next Arrow Btn'), 
    10)

Mobile.delay(5)

//validate if the finish msg is shown 
Mobile.verifyElementExist(findTestObject('04.Mobile/02.Android/01.FS.GJ-FieldServicesActions/Service Appointment Work Order Page/android.widget.Change Status - Finish - Btn'), 
    5)
