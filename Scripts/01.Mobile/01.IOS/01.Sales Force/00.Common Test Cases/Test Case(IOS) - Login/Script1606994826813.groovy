...
if (startAppPath != '') {
    Mobile.startApplication(startAppPath, false)
}

//Mobile.startApplication('/Users/temp/Desktop/Apps/Field Service 228.0.1.ipa', false)
//Mobile.startExistingApplication('/Users/lakshmi.kandikuppa/Downloads/Field Service 228.0.1.ipa', true)
Mobile.comment('##### - Verify if we needs to input PassCode or Login info')

if (passCode != '') {
    CustomKeywords.'IOS.EnterPasscode'(passCode, Mobile.tap(findTestObject('04.Mobile/01.IOS/00.Common Objects/03. Button Objects/btnDone'), 
            10))
